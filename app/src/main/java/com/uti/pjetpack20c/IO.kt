...
//                            buat  btn hitung
                            Button(modifier =  Modifier.weight(1f), onClick = {
                                ...
                                // *bisa pakai format ini
                                // * var hasil = 0
                                // hasil = txt_nilai1.toInt() + txt_nilai2.toInt()
                                // txt_hasil = hasil.toString()

                                //jika dropdown = 1(tambah)
                                if(selectedText == operator[1])
                                {
                                    txt_hasil = (txt_nilai1.toInt() + txt_nilai2.toInt()).toString(
                                }

                                //jika dropdown = 2(kurang)
                                if(selectedText == operator[2])
                                {
                                    txt_hasil = (txt_nilai1.toInt() - txt_nilai2.toInt()).toString(
                                }

                                //jika dropdown = 3(kali)
                                if(selectedText == operator[3])
                                {
                                    txt_hasil = (txt_nilai1.toInt() * txt_nilai2.toInt()).toString(
                                }

                                //jika dropdown = 4(bagi)
                                if(selectedText == operator[4])
                                {
                                    txt_hasil = (txt_nilai1.toFloat() / txt_nilai2.toInt()).toString()
                                }
